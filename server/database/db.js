...
const Connection = async (username, password) => {
  ...
  const URL = `mongodb+srv://${username}:${password}@cluster0.gg9lco5.mongodb.net/tinder-clone?retryWrites=true&w=majority`;
  try {
    ...
    console.log("Error: Not connected to the DB 💁‍♂️", error.message);
  }
};
